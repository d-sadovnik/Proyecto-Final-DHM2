...
def cargar_ejercicios():
    ...
    if not exercises:
        ...
        new_exercises_3=Exercises(name='BENCH DIPS', burnt_calories=0, muscle_id=1, description="Bench dips are a compound exercise as they worked multiple muscle groups simultaneously. Although this bodyweight exercise mainly targets the triceps, it also hits your chest and front of your shoulder.Bench dips are one of the most effective exercises to increase arm strength and also build lean muscle in your upper arms.Bench dips are a closed kinetic chain exercise and express that you do the movements around a fixed point. It increases compression force on your joints thereby improving stability.")
        new_exercises_4=Exercises(name='ONE ARM LYING TRICEPS EXTENSION', burnt_calories=0, muscle_id=1, description="Dumbbell lying triceps extension is a single joint isolating exercise that provides strength and muscle development. It is a effective exercise to develop the tricep muscle.")
        new_exercises_5=Exercises(name='TRICEPS DIPS ON FLOOR', burnt_calories=0, muscle_id=1, description="Triceps dips on floor are a compound exercise as they worked multiple muscle groups simultaneously. Although this bodyweight exercise mainly targets the triceps, it also hits your chest and front of your shoulder.Triceps dips on floor are one of the most effective exercises to increase arm strength and also build lean muscle in your upper arms.")
        new_exercises_6=Exercises(name='NARROW GRIP WALL PUSH-UP', burnt_calories=0, muscle_id=1, description="The Narrow Grip Wall Push-Up is an easy push-up variation that is preferred by those who are new to exercise or who cannot do push-ups as an alternative to doing push-ups. It is a compound exercise that requires no equipment and works multiple muscle groups at the same time.")
        new_exercises_7=Exercises(name='SHOULDER STRETCH BEHIND BACK', burnt_calories=0, muscle_id=1, description="The Shoulder flexibility test is a simple flexibility test to determine whether the hands can be brought together from behind and to detect shoulder range of motion.Start by reaching your right arm overhead and behind your neck to touch your upper back.Lift your left arm and move it around your left side to your lower back, then slowly reach upward as far as possible toward your right hand.")
        new_exercises_8=Exercises(name='BODY UPS', burnt_calories=0, muscle_id=1, description="Body Ups is an compound triceps exercise that increases arm strength and develop arm muscles. Although the focus is on the triceps muscles, it also works the chest, shoulder and back muscles.")
        new_exercises_9=Exercises(name='BENCH DIPS ON FLOOR', burnt_calories=0, muscle_id=1, description="Triceps dips on floor are a compound exercise as they worked multiple muscle groups simultaneously. Although this bodyweight exercise mainly targets the triceps, it also hits your chest and front of your shoulder.Triceps dips on floor are one of the most effective exercises to increase arm strength and also build lean muscle in your upper arms.")
        new_exercises_10=Exercises(name='CROSS ARM PUSH-UP', burnt_calories=0, muscle_id=1, description="Cross arm push-up are a more difficult variant of classic push-ups and are made by lifting your body weight by joining your hands in a crossover.")
        new_exercises_11=Exercises(name='STANDING CALF RAISE', burnt_calories=0, muscle_id=6, description="")
        new_exercises_12=Exercises(name='STANDING CROSS LEG HAMSTRING STRETCH', burnt_calories=0, muscle_id=6, description="")
        new_exercises_13=Exercises(name='WEIGHTED DONKEY CALF RAISE', burnt_calories=0, muscle_id=6, description="")
        new_exercises_14=Exercises(name='SQUAT HOLD CALF RAISE', burnt_calories=0, muscle_id=6, description="")
        new_exercises_15=Exercises(name='STANDING HAMSTRING STRETCH', burnt_calories=0, muscle_id=6, description="")
        new_exercises_16=Exercises(name='BAND FOOT EXTERNAL ROTATION', burnt_calories=0, muscle_id=6, description="")
        new_exercises_17=Exercises(name='TOE EXTENSOR STRETCH', burnt_calories=0, muscle_id=6, description="")
        new_exercises_18=Exercises(name='STANDING DORSIFLEXION', burnt_calories=0, muscle_id=6, description="")
        new_exercises_19=Exercises(name='STANDING TOE FLEXOR STRETCH', burnt_calories=0, muscle_id=6, description="")
        new_exercises_20=Exercises(name='POSTERIOR TIBIALIS STRETCH', burnt_calories=0, muscle_id=6, description="")
        new_exercises_21=Exercises(name='DOUBLE ARM DUMBBELL CURL', burnt_calories=0, muscle_id=2, description="Dumbbell curl is also known as Biceps Curl. It is one of the most popular moves that comes to mind when you think of arm training.")
        new_exercises_22=Exercises(name='DUMBBELL CURL', burnt_calories=0, muscle_id=1, description="Dumbbell curl is also known as Biceps Curl. It is one of the most popular moves that comes to mind when you think of arm training.")
        new_exercises_23=Exercises(name='SEATED İNCLINE DUMBBELL CURL', burnt_calories=0, muscle_id=2,description="Incline dumbbell curl is an isolation exercise that works the long head of your biceps, stretches it and helps it in contracting with more force during the exercise. If your goal is to get stronger and bigger arms, you can add incline dumbbell curls to your exercise routine.The primary target of incline dumbbell curl movement is the biceps brachii muscle. Additionally, you can use this movement to correct symmetry issues. (for example, if one bicep is bigger than another)")
        new_exercises_24=Exercises(name='ONE ARM CABLE CURL', burnt_calories=0, muscle_id=2, description="The one arm cable curl is an isolation exercise for the biceps muscle. It’s a pulling action performed with a cable machine and is suitable for beginners. The cable keeps tension on your biceps during both the lowering and the lifting part of each rep so they are always engaged. The cable’s constant tension means you work your biceps hard.")
        new_exercises_25=Exercises(name='DUMBBELL REVERSE CURL', burnt_calories=0, muscle_id=2, description="The first target of this exercise is the brachioradialis muscle. The brachioradialis is a superficial forearm muscle located in the lateral forearm.The development of the brachioradialis muscle helps to strengthen your grip and can make your arm muscles appear stronger and more voluminous.")
        new_exercises_26=Exercises(name='STANDING ONE ARM CHEST STRETCH', burnt_calories=0, muscle_id=2, description="")
        new_exercises_27=Exercises(name='BAND BICEPS CURL', burnt_calories=0, muscle_id=2, description="")
        new_exercises_28=Exercises(name='SINGLE DUMBBELL SPIDER HAMMER CURL', burnt_calories=0, muscle_id=2, description="Dumbbell curl is also known as Biceps Curl. It is one of the most popular moves that comes to mind when you think of arm training.")
        new_exercises_29=Exercises(name='HAMMER CURL WITH RESISTANCE BAND', burnt_calories=0, muscle_id=2, description="Dumbbell curl is also known as Biceps Curl. It is one of the most popular moves that comes to mind when you think of arm training.")
        new_exercises_30=Exercises(name='WATER BOTTLE HAMMER CURL', burnt_calories=0, muscle_id=2, description="Dumbbell curl is also known as Biceps Curl. It is one of the most popular moves that comes to mind when you think of arm training.")
        new_exercises_31=Exercises(name='PULL-UP', burnt_calories=0, muscle_id=3, description="When it comes to compound exercises, one of the best exercises that comes to mind is probably the pull-up movement. Pull-up is a closed-chain an exercise that works almost all of the muscle groups on the upper body and provides both hypertrophy and strength at body weight.")
        new_exercises_32=Exercises(name='CABLE REAR PULLDOWN', burnt_calories=0, muscle_id=1, description="Cable Rear Lat Pulldown is one of the most popular exercises used to strengthen the back muscles. Pulldown V-Taper is among the movements that allow you to reach the image.")
        new_exercises_33=Exercises(name='LAT PULLDOWN', burnt_calories=0, muscle_id=3, description="Lat pulldown is one of the most popular exercises used to strengthen the back muscles. Pulldown V-Taper is among the movements that allow you to reach the image. It provides interaction in teres minor and teres major muscle groups for the development of the rear shoulder and wing muscles. In this way, you can create a wider back, wing and shoulder structure.")
        new_exercises_34=Exercises(name='LEVER FRONT PULLDOWN', burnt_calories=0, muscle_id=3, description="Lat pulldown is one of the most popular exercises used to strengthen the back muscles. Pulldown V-Taper is among the movements that allow you to reach the image. It provides interaction in teres minor and teres major muscle groups for the development of the rear shoulder and wing muscles. In this way, you can create a wider back, wing and shoulder structure.")
        new_exercises_35=Exercises(name='SEATED CABLE ROW', burnt_calories=0, muscle_id=3, description="Many of the movements that work the same muscle group may look alike, but they focus on different parts of the muscles because they are at different angles. If you want to build better muscle specifically, keep in mind that it is more beneficial to include exercises that focus on different aspects to your training program.")
        new_exercises_36=Exercises(name='ONE ARM CABLE ROW', burnt_calories=0, muscle_id=3, description="One arm cable row is a pulling exercise that works the back muscles in general, particularly the latissimus dorsi.")
        ...
        new_exercises_49=Exercises(name='LYING SCISSOR KICK', burnt_calories=0, muscle_id=4, description="Lying scissor kick targets all of your abdominal muscles, especially the lower regions. movements.")
        ...
        new_exercises_51=Exercises(name='ARM SCISSORS', burnt_calories=0, muscle_id=5, description="Stand with your feet shoulder width apart.Lift your arms at shoulder height and cross them in front of your chest.Change the other arm on the top each time you cross.")
        new_exercises_52=Exercises(name='SIDE ARM RAISES', burnt_calories=0, muscle_id=5, description="Stand with your arms at your sides.Keep your back and arms straightRaise your arms to your sides at shoulder height.Exhale as you raise your arms, and inhale as you lower them.Return and repeat.")
        new_exercises_53=Exercises(name='ARM CIRCLES', burnt_calories=0, muscle_id=5, description="The arm circle is a type of dynamic warm-up. Doing arm circles before starting a workout is a practical way to increase range of motion in the joints. Also, if you add this exercise to the beginning of your training program, it will warm up your shoulders, trapezius, chest, arms and upper back muscles.")
        new_exercises_54=Exercises(name='CABLE LATERAL RAISE', burnt_calories=0, muscle_id=5, description="Cable lateral raise is the most popular shoulder development and strengthening exercise targeting the lateral deltoid.Lateral raise exercise with cable machines provides constant tension and continuous resistance while lifting and lowering the weight. Because muscle growth and strength gains are directly dependent on how much the muscle is stretched during exercise, cable machines tire the muscles faster and provide greater strength gain.")
        new_exercises_55=Exercises(name='ALTERNATING DUMBBELL FRONT RAISE', burnt_calories=0, muscle_id=5, description="The Dumbbell front raise is a isole exercise that targets the fronts and sides of the shoulders.")
        new_exercises_56=Exercises(name='DUMBBELL FRONT RAISE', burnt_calories=0, muscle_id=5, description="The Dumbbell front raise is a isole exercise that targets the fronts and sides of the shoulders.")
        new_exercises_57=Exercises(name='CABLE FRONT RAISE', burnt_calories=0, muscle_id=5, description="Cable front raise is the most popular shoulder development and strengthening exercise targeting the anterior deltoid.Front raise exercise with cable machines provides constant tension and continuous resistance while lifting and lowering the weight. Because muscle growth and strength gains are directly dependent on how much the muscle is stretched during exercise, cable machines tire the muscles faster and provide greater strength gain.")
        ...
        new_exercises_65=Exercises(name='CABLE CROSSOVER', burnt_calories=0, muscle_id=7, description="Cable crossover exercise is an excellent exercise to stretch your chest muscles, increase the range of motion and shred chest muscles. There are 3 types of movement. These types vary depending on how you use the station. In the pulley system, your direction of pulling the cables and the height you connect the rope allow you to target the upper, middle and lower parts of your chest muscles separately.The tension in the cable provides a softer and more continuous resistance than free weights that can be affected by momentum. Thanks to constant resistance, it triggers the work of many small stabilizing muscles in your chest in addition to the pectoral muscles.")
        new_exercises_66=Exercises(name='SINGLE-ARM CABLE CROSSOVER', burnt_calories=0, muscle_id=7, description="The single arm cable crossover is an upper body exercise that targets the chest muscles. Working the chest one side at a time allows you to focus on the balance between the sides of your chest and really feel the chest muscles contracting. The tension in the cable provides a softer and more continuous resistance than free weights that can be affected by momentum. In addition, performing the exercise on each arm separately allows both chest to work equally")
        new_exercises_67=Exercises(name='REVERSE GRIP INCLINE DUMBBELL PRESS', burnt_calories=0, muscle_id=7, description="The reverse grip incline dumbbell press is an upper-body exercise targeting the upper pectoral muscles. The reverse grip helps keep your elbows in and your upper arms parallel to your torso.")
        new_exercises_68=Exercises(name='WALL PUSH-UP', burnt_calories=0, muscle_id=7, description="Wall push-ups are an easier option for people who are just starting out or cannot do classic push-ups.Wall Push-Up requires more than one joint to work simultaneously while forcing your body to stabilize. It helps to increase performance by working other muscle groups to stabilize your body and gain strength.")
        new_exercises_69=Exercises(name='KNEELING PUSH-UP', burnt_calories=0, muscle_id=7, description="Kneeling push-ups are an easier option for beginners or those who can’t do push-ups. Although the push-up mainly targets the chest muscles, it is a bodyweight exercise that works your triceps and front shoulder muscles.")
        new_exercises_70=Exercises(name='INCLINE PUSH-UP', burnt_calories=0, muscle_id=7, description=" Although the push-up mainly targets the chest muscles, it is a bodyweight exercise that works your triceps and front shoulder muscles.")
        new_exercises_71=Exercises(name='WALKING', burnt_calories=0, muscle_id=8, description="Walking is one of the simplest physical activities. This simple activity allows you to work many large and small muscle groups in your lower body.")
        new_exercises_72=Exercises(name='RIDING OUTDOOR BICYCLE', burnt_calories=8, muscle_id=8, description="")
        new_exercises_73=Exercises(name='BRISKLY WALKING', burnt_calories=0, muscle_id=8, description="Walking is one of the simplest physical activities. This simple activity allows you to work many large and small muscle groups in your lower body.")
        new_exercises_74=Exercises(name='RUNNING', burnt_calories=0, muscle_id=8, description="Walking is a great tool to prepare your body for running. Your walking in start should consist of a mixture of running and walking depending on how much pressure your body can take. As time passes your muscles get trained and you are good to go for running.")
