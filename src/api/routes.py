...
def handle_login():
    email = request.json.get("email", None)
    password = request.json.get("password", None)
    usuario_query = User.query.filter_by(
...
def cargar_ejercicios():
    ...
    if not exercises:
        new_exercises_1 = Exercises(name='DUMBBELL KICKBACK', burnt_calories=0, muscle_id=1,
        ...
        new_exercises_2 = Exercises(name='BENT OVER KICKBACK', burnt_calories=0, muscle_id=1,
        ...
        new_exercises_4 = Exercises(name='ONE ARM LYING TRICEPS EXTENSION', burnt_calories=0, muscle_id=1,
        ...
        new_exercises_5 = Exercises(name='TRICEPS DIPS ON FLOOR', burnt_calories=0, muscle_id=1,
        ...
        new_exercises_6 = Exercises(name='NARROW GRIP WALL PUSH-UP', burnt_calories=0, muscle_id=1,
        ...
        new_exercises_7 = Exercises(name='SHOULDER STRETCH BEHIND BACK', burnt_calories=0, muscle_id=1,
        ...
        new_exercises_8 = Exercises(name='BODY UPS', burnt_calories=0, muscle_id=1,
        ...
        new_exercises_9 = Exercises(name='BENCH DIPS ON FLOOR', burnt_calories=0, muscle_id=1,
                                    description="Triceps dips on floor are a compound exercise as they worked multiple muscle groups simultaneously. Although this bodyweight exercise mainly targets the triceps, it also hits your chest and front of your shoulder.Triceps dips on floor are one of the most effective exercises to increase arm strength and also build lean muscle in your upper arms.")
        new_exercises_10 = Exercises(name='CROSS ARM PUSH-UP', burnt_calories=0, muscle_id=1,
        ...
        new_exercises_11 = Exercises(
            name='STANDING CALF RAISE', burnt_calories=0, muscle_id=6, description="")
        new_exercises_12 = Exercises(
            name='STANDING CROSS LEG HAMSTRING STRETCH', burnt_calories=0, muscle_id=6, description="")
        new_exercises_13 = Exercises(
            name='WEIGHTED DONKEY CALF RAISE', burnt_calories=0, muscle_id=6, description="")
        new_exercises_14 = Exercises(
            name='SQUAT HOLD CALF RAISE', burnt_calories=0, muscle_id=6, description="")
        new_exercises_15 = Exercises(
            name='STANDING HAMSTRING STRETCH', burnt_calories=0, muscle_id=6, description="")
        new_exercises_16 = Exercises(
            name='BAND FOOT EXTERNAL ROTATION', burnt_calories=0, muscle_id=6, description="")
        new_exercises_17 = Exercises(
            name='TOE EXTENSOR STRETCH', burnt_calories=0, muscle_id=6, description="")
        new_exercises_18 = Exercises(
            name='STANDING DORSIFLEXION', burnt_calories=0, muscle_id=6, description="")
        new_exercises_19 = Exercises(
            name='STANDING TOE FLEXOR STRETCH', burnt_calories=0, muscle_id=6, description="")
        new_exercises_20 = Exercises(
            name='POSTERIOR TIBIALIS STRETCH', burnt_calories=0, muscle_id=6, description="")
        new_exercises_21 = Exercises(name='DOUBLE ARM DUMBBELL CURL', burnt_calories=0, muscle_id=2,
        ...
        new_exercises_22 = Exercises(name='DUMBBELL CURL', burnt_calories=0, muscle_id=1,
                                     description="Dumbbell curl is also known as Biceps Curl. It is one of the most popular moves that comes to mind when you think of arm training.")
        ...
        new_exercises_24 = Exercises(name='ONE ARM CABLE CURL', burnt_calories=0, muscle_id=2,
        ...
        new_exercises_25 = Exercises(name='DUMBBELL REVERSE CURL', burnt_calories=0, muscle_id=2,
        ...
        new_exercises_26 = Exercises(
            name='STANDING ONE ARM CHEST STRETCH', burnt_calories=0, muscle_id=2, description="")
        new_exercises_27 = Exercises(
            name='BAND BICEPS CURL', burnt_calories=0, muscle_id=2, description="")
        new_exercises_28 = Exercises(name='SINGLE DUMBBELL SPIDER HAMMER CURL', burnt_calories=0, muscle_id=2,
                                     description="Dumbbell curl is also known as Biceps Curl. It is one of the most popular moves that comes to mind when you think of arm training.")
        new_exercises_29 = Exercises(name='HAMMER CURL WITH RESISTANCE BAND', burnt_calories=0, muscle_id=2,
                                     description="Dumbbell curl is also known as Biceps Curl. It is one of the most popular moves that comes to mind when you think of arm training.")
        new_exercises_30 = Exercises(name='WATER BOTTLE HAMMER CURL', burnt_calories=0, muscle_id=2,
                                     description="Dumbbell curl is also known as Biceps Curl. It is one of the most popular moves that comes to mind when you think of arm training.")
        new_exercises_31 = Exercises(name='PULL-UP', burnt_calories=0, muscle_id=3,
        ...
        new_exercises_32 = Exercises(name='CABLE REAR PULLDOWN', burnt_calories=0, muscle_id=1,
        ...
        new_exercises_34 = Exercises(name='LEVER FRONT PULLDOWN', burnt_calories=0, muscle_id=3,
                                     description="Lat pulldown is one of the most popular exercises used to strengthen the back muscles. Pulldown V-Taper is among the movements that allow you to reach the image. It provides interaction in teres minor and teres major muscle groups for the development of the rear shoulder and wing muscles. In this way, you can create a wider back, wing and shoulder structure.")
        new_exercises_35 = Exercises(name='SEATED CABLE ROW', burnt_calories=0, muscle_id=3,
        ...
        new_exercises_36 = Exercises(name='ONE ARM CABLE ROW', burnt_calories=0, muscle_id=3,
        ...
        new_exercises_38 = Exercises(name='INCLINE DUMBBELL ROW', burnt_calories=0, muscle_id=3,
                                     description="Many of the movements that work the same muscle group may look alike, but they focus on different parts of the muscles because they are at different angles. If you want to build better muscle specifically, keep in mind that it is more beneficial to include exercises that focus on different aspects to your training program.")
        ...
        new_exercises_40 = Exercises(
            name='', burnt_calories=0, muscle_id=3, description="se repite 40 con 38")
        new_exercises_41 = Exercises(name='MOUNTAIN CLIMBER', burnt_calories=0, muscle_id=4,
        ...
        new_exercises_42 = Exercises(
            name='CROSS BODY MOUNTAIN CLIMBER', burnt_calories=0, muscle_id=4, description="se repite")
        new_exercises_43 = Exercises(name='SEATED BENCH LEG PULL-IN', burnt_calories=0, muscle_id=4,
        ...
        new_exercises_45 = Exercises(
            name='CROSS CRUNCH', burnt_calories=0, muscle_id=4, description="se repite 44 y 45")
        new_exercises_46 = Exercises(name='LEG RAISE', burnt_calories=0, muscle_id=4,
                                     description="Leg raise is one of the most effective exercises for the lower abdominal muscles.")
        new_exercises_47 = Exercises(name='ALTERNATE LEG RAISES', burnt_calories=0, muscle_id=4,
                                     description="Leg raise is one of the most effective exercises for the lower abdominal muscles.")
        ...
        new_exercises_49 = Exercises(name='LYING SCISSOR KICK', burnt_calories=0, muscle_id=4,
        ...
        new_exercises_51 = Exercises(name='ARM SCISSORS', burnt_calories=0, muscle_id=5,
        ...
        new_exercises_52 = Exercises(name='SIDE ARM RAISES', burnt_calories=0, muscle_id=5,
        ...
        new_exercises_53 = Exercises(name='ARM CIRCLES', burnt_calories=0, muscle_id=5,
        ...
        new_exercises_55 = Exercises(name='ALTERNATING DUMBBELL FRONT RAISE', burnt_calories=0, muscle_id=5,
                                     description="The Dumbbell front raise is a isole exercise that targets the fronts and sides of the shoulders.")
        new_exercises_56 = Exercises(name='DUMBBELL FRONT RAISE', burnt_calories=0, muscle_id=5,
                                     description="The Dumbbell front raise is a isole exercise that targets the fronts and sides of the shoulders.")
        ...
        new_exercises_58 = Exercises(name='BODYWEIGHT MILITARY PRESS', burnt_calories=0, muscle_id=5,
        ...
        new_exercises_60 = Exercises(name='ONE ARM KETTLEBELL SNATCH', burnt_calories=0, muscle_id=7,
        ...
        new_exercises_61 = Exercises(name='ARM_SCISSORS', burnt_calories=0, muscle_id=7,
                                     description="Stand with your feet shoulder width apart.Lift your arms at shoulder height and cross them in front of your chest.Change the other arm on the top each time you cross.")
        new_exercises_62 = Exercises(name='LOW CABLE CROSSOVER', burnt_calories=0, muscle_id=7,
        ...
        new_exercises_63 = Exercises(name='HIGH CABLE CROSSOVER', burnt_calories=0, muscle_id=7,
        ...
        new_exercises_67 = Exercises(name='REVERSE GRIP INCLINE DUMBBELL PRESS', burnt_calories=0, muscle_id=7,
        ...
        new_exercises_68 = Exercises(name='WALL PUSH-UP', burnt_calories=0, muscle_id=7,
        ...
        new_exercises_69 = Exercises(name='KNEELING PUSH-UP', burnt_calories=0, muscle_id=7,
        ...
        new_exercises_70 = Exercises(name='INCLINE PUSH-UP', burnt_calories=0, muscle_id=7,
        ...
        new_exercises_71 = Exercises(name='WALKING', burnt_calories=0, muscle_id=8,
        ...
        new_exercises_72 = Exercises(
            name='RIDING OUTDOOR BICYCLE', burnt_calories=8, muscle_id=8, description="")
        new_exercises_73 = Exercises(name='BRISKLY WALKING', burnt_calories=0, muscle_id=8,
                                     description="Walking is one of the simplest physical activities. This simple activity allows you to work many large and small muscle groups in your lower body.")
        new_exercises_74 = Exercises(name='RUNNING', burnt_calories=0, muscle_id=8,
        ...
        new_exercises_75 = Exercises(
            name='JUMP ROPE', burnt_calories=0, muscle_id=5, description="")
        new_exercises_76 = Exercises(
            name='ELBOW TO KNEE TWIST', burnt_calories=0, muscle_id=8, description="")
        new_exercises_77 = Exercises(
            name='PUSH-UP TOE TOUCH', burnt_calories=0, muscle_id=8, description="")
        new_exercises_78 = Exercises(name='MOUNTAIN_CLIMBER', burnt_calories=0, muscle_id=8,
                                     description="Assume a normal press-up position with your weight on your hands and toes, your back and legs straight, and your hands shoulder-width apart.")
        new_exercises_79 = Exercises(name='BICYCLE_CRUNCH', burnt_calories=0, muscle_id=8,
        ...
        new_exercises_80 = Exercises(name='T-CROSS SIT-UP', burnt_calories=0, muscle_id=8,
...
@api.route("/addtracker", methods=["POST"])
def add_tracker():
    user_id = request.json.get("user_id", None)
    burnt_cals = request.json.get("burnt_cals", None)
    total_distance = request.json.get("total_distance", None)
    daily_steps = request.json.get("daily_steps", None)
    date = datetime.now()
    new_tracker = Tracker_free(burnt_cals=burnt_cals, total_distance=total_distance,
                               daily_steps=daily_steps, date=date, freeuser_id=user_id)
    db.session.add(new_tracker)
    db.session.commit()
    respuesta = {
        'msg': 'tracker registrado'
    }
    return jsonify(respuesta), 200


@api.route("/addprofile", methods=["POST"])
def add_profile():
    user_id = request.json.get("user_id", None)
    age = request.json.get("age", None)
    height = request.json.get("height", None)
    weight = request.json.get("weight", None)
    bmi = request.json.get("bmi", None)
    fat_percentage = request.json.get("fat_percentage", None)
    new_profile = Profile(user_id=user_id, age=age, height=height,
                          weight=weight, bmi=bmi, fat_percentage=fat_percentage)
